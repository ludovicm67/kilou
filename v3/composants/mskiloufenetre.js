...
//FENETRE
BCKGROUND		=	"#000000";	//Couleur de fond de la fenetre
BORDER			=	"#000000";	//Couleur de la bordure

//BANDEAU
B_BCKGROUND		=	"#000000";	//Couleur du bandeau
...
function CreerPdcFenetre( titre, largeur, hauteur, posLeft, posTop, contenu ){
	...
	fenetre.style.left = posLeft - "1px";
	fenetre.style.top = posTop - "1px";
...
function PdcBouttonOnMouseUpFermer(){
	...
	if( CONFIRME_FERMETURE )
		if( !confirm("IMPOSSIBLE DE FERMER '}MS-KILOU{'") )
			return;
...
<table style="width: 100px; background-Color: #000000; cursor: move;">	
<tr>
